...
|------|-----------|-------|
| ~~`src/components/ui/Container.tsx`~~ | ~~Container~~ | ~~Exported via barrel but never imported~~ — **RESOLVED 2026-04-28** (commit `c85c54c`). File deleted, barrel export removed. |
| ~~`src/components/ui/Divider.tsx`~~ | ~~Divider~~ | ~~Exported via barrel but never imported~~ — **RESOLVED 2026-04-28** (commit `c85c54c`). File deleted, barrel export removed. |
